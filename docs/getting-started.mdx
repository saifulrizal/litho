---
id: getting-startedpublic class SampleApplication extends Application {
  @Override
...
First, initialize `SoLoader`. Litho has a dependency on [SoLoader](https://github.com/facebook/SoLoader) to help load native libraries provided by the underlying layout engine, [Yoga](https://yogalayout.dev/docs/about-yoga). Your `Application` class is a good place to do this:
